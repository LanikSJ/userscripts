...
Thank you for your interest in contributing to LanikSJ/userscripts! This document
...
1. **Discuss first**: Open an issue or contact maintainers via
   [GitHub Discussions](https://github.com/LanikSJ/userscripts/discussions) before making significant
   changes

2. **Review existing issues**: Check if there's already work in progress
   on your intended changes

3. **Understand the project**: Read through existing user scripts to
...
- **User Scripts**: New TamperMonkey, ViolentMonkey, or AdGuard user scripts

- **Bug fixes**: Corrections to existing user scripts
...
- [ ] Test your user scripts thoroughly in your browser
- [ ] Ensure scripts don't cause false positives or break website functionality
- [ ] Follow the established user script format and syntax (GreaseMonkey/TamperMonkey standards)
- [ ] Keep scripts as specific as possible to avoid over-blocking
...
- [ ] User scripts follow GreaseMonkey/TamperMonkey syntax and best practices
- [ ] Scripts are validated using available testing tools
...
- Add clear comments for complex or non-obvious functionality
- Group related functionality together
- Use descriptive function and variable names
- Follow GreaseMonkey/TamperMonkey user script syntax and best practices
- Include proper metadata block with @name, @namespace, @version, @description, @author, @license, @match, @grant
...
[GitHub Issues](https://github.com/LanikSJ/userscripts/issues).
...
- Contacting us at [GitHub Discussions](https://github.com/LanikSJ/userscripts/discussions)

Thank you for contributing to LanikSJ/userscripts!
